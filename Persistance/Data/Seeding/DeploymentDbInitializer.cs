...
{
    public class DeploymentDbInitializer
    {
        private readonly AppDbContext _context;

        public DeploymentDbInitializer(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                var OrgsData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "organizations.json"));
            ...
            {
                var usersData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "users.json"));
            ...
            {
                var teamsData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "teams.json"));
            ...
            {
                var teamMembersData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "teamMembers.json"));
            ...
            {
                var ProjectsData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "Projects.json"));
            ...
            {
                var tasksData = File.ReadAllText(Path.Combine("Persistance", "Data", "Seeding", "tasks.json"));
